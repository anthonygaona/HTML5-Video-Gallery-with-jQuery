$(function() {
    ...
    //HTML5 Player code with Flash fallback
    $(".videoLink").click(function() {
        
        var videoFile = $(this).attr('videofile'),
            videoPoster = $(this).attr('videoposter'),
            videoWidth = Number($(this).attr('videowidth')),
            videoHeight = Number($(this).attr('videoheight'));
        ...
        // Activate video tag for Android
        ...
        // Option 2 - comment out option one and Android code above
        // Detect for both Android, iPhone and iPod, and redirect to video
        // var checkBrowser = navigator.userAgent.toLowerCase();
        // var isAndroid = checkBrowser.indexOf('android') > -1;
